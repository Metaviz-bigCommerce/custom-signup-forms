    ...
    >
      ...
      >
        ...
        <div className={`relative bg-gradient-to-br ${theme.headerBg} px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200`}>
          ...
          <div className="flex items-center gap-3 sm:gap-4 pr-8 sm:pr-10">
            <div className="relative shrink-0">
              <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${avatarGradient} flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-lg`}>
                {requestInitials}
              </div>
              <div className={`absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 rounded-lg ${theme.accentBg} flex items-center justify-center border-2 border-white shadow-md`}>
                <StatusIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" />
              </div>
            </div>
